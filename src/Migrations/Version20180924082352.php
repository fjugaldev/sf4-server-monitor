 ...
 */
final class Version20180924082352 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__server AS SELECT id, owner_id, display_name, url, check_every, timeout, is_disabled, notification_email, notification_phone, send_desktop_notification, use_push_bullet, last_status_verification FROM server');
        $this->addSql('DROP TABLE server');
        $this->addSql('CREATE TABLE server (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, owner_id INTEGER NOT NULL, display_name VARCHAR(180) NOT NULL COLLATE BINARY, url VARCHAR(255) NOT NULL COLLATE BINARY, check_every INTEGER NOT NULL, timeout INTEGER NOT NULL, is_disabled BOOLEAN NOT NULL, notification_email VARCHAR(255) NOT NULL COLLATE BINARY, notification_phone VARCHAR(40) NOT NULL COLLATE BINARY, send_desktop_notification BOOLEAN NOT NULL, use_push_bullet BOOLEAN NOT NULL, last_status_verification DATETIME DEFAULT NULL, CONSTRAINT FK_5A6DD5F67E3C61F9 FOREIGN KEY (owner_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO server (id, owner_id, display_name, url, check_every, timeout, is_disabled, notification_email, notification_phone, send_desktop_notification, use_push_bullet, last_status_verification) SELECT id, owner_id, display_name, url, check_every, timeout, is_disabled, notification_email, notification_phone, send_desktop_notification, use_push_bullet, last_status_verification FROM __temp__server');
