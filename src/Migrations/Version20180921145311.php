 ...
 */
final class Version20180921145311 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__monitor_history AS SELECT id, server_id, server_status, response_code, load_time FROM monitor_history');
        $this->addSql('DROP TABLE monitor_history');
        $this->addSql('CREATE TABLE monitor_history (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, server_id INTEGER NOT NULL, server_status VARCHAR(40) NOT NULL COLLATE BINARY, response_code INTEGER NOT NULL, load_time DOUBLE PRECISION NOT NULL, created_at DATETIME NOT NULL, CONSTRAINT FK_74D654201844E6B7 FOREIGN KEY (server_id) REFERENCES server (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO monitor_history (id, server_id, server_status, response_code, load_time) SELECT id, server_id, server_status, response_code, load_time FROM __temp__monitor_history');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__monitor_history AS SELECT id, server_id, server_status, response_code, load_time FROM monitor_history');
        $this->addSql('DROP TABLE monitor_history');
        $this->addSql('CREATE TABLE monitor_history (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, server_id INTEGER NOT NULL, server_status VARCHAR(40) NOT NULL, response_code INTEGER NOT NULL, load_time DOUBLE PRECISION NOT NULL)');
        $this->addSql('INSERT INTO monitor_history (id, server_id, server_status, response_code, load_time) SELECT id, server_id, server_status, response_code, load_time FROM __temp__monitor_history');
        $this->addSql('DROP TABLE __temp__monitor_history');
        $this->addSql('CREATE INDEX IDX_74D654201844E6B7 ON monitor_history (server_id)');
        $this->addSql('DROP INDEX IDX_DBB43A02A76ED395');
