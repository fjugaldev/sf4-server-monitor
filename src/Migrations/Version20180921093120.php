 ...
 */
final class Version20180921093120 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, name, email, username, password, roles, created_at, updated_at FROM user');
        ...
        $this->addSql('INSERT INTO user (id, name, email, username, password, roles, created_at, updated_at) SELECT id, name, email, username, password, roles, created_at, updated_at FROM __temp__user');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__response_code AS SELECT id, code, description FROM response_code');
        ...
        $this->addSql('INSERT INTO response_code (id, code, description) SELECT id, code, description FROM __temp__response_code');
